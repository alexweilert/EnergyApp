...
class StockScreenV3 extends StatefulWidget {
  final PostgresDatabase database;
  StockScreenV3({required this.database});

  @override
  _StockScreenStateV3 createState() => _StockScreenStateV3();
}

class _StockScreenStateV3 extends State<StockScreenV3> with SingleTickerProviderStateMixin {
  ...
  double getMinY() {
    ...
    double result2 = minY2 - (maxY2 - minY2) * 0.1-10;
  ...
  double getMaxY() {
    ...
    double result2 = maxY2 + (maxY2 - minY2) * 0.1 + 10;
    //Checks which min is smaller and returns it
    return result2;
  }
